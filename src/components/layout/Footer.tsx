      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-cream/10">
          <div className="flex items-center gap-4">
            {renderSocialIconLink("Facebook", "https://facebook.com")}
            {renderSocialIconLink("Instagram", "https://instagram.com")}
            {renderSocialIconLink("LinkedIn", "https://linkedin.com")}
            {renderSocialIconLink("YouTube", "https://youtube.com")}
          </div>
        </div>
